      ...
      <table id="lista" class="table table-striped table-bordered">
        ...
        <tbody>
          ...
          foreach ($listaUsuarios as $usuario) {
            ...
            $nombreUsuario = trim($usuario->nombre . " " . $usuario->apellido1) . " " . $usuario->apellido2;

            echo "<tr><td>" . $nombreUsuario . "</td>" .
              "<td>" . $usuario->email . "</td>" .
              "<td>" . $usuario->materia_id . "</td>" . // Mostrar el nombre de la materia
              "<td>" . $usuario->tipo . "</td>" .
              "<td><form method='post'>" .
