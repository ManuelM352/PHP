...
<head>
  ...
  <title>Sistema de registropara materias</title>
  ...
  <body>
    ...
    if (isset($_POST["id"]) && is_numeric($_POST["id"])) {
      ...
      if ($dao->eliminar($_POST["id"])) {
        $_SESSION["msj"] = "success-La materia ha sido eliminado correctamente";
      } else {
        $_SESSION["msj"] = "danger-No se ha podido eliminar la materia seleccionado";
      }
    }
    $listaMateria = $dao->obtenerTodos();
    ?>
    ...
    <div class="container">
      ...
      ?>
      <h1>Materias</h1>
      <a class="btn btn-success mt-5 mb-3" href="registroMateria.php">Agregar</a>
        ...
        <tbody>
          ...
          foreach ($listaMateria as $materia) {
            echo "<tr>" .
              ...
              "<td>" . $materia->codigo_de_materia . "</td>" .
              "<td>" . $materia->descripcion . "</td>" .
              "<td>" . $materia->creditos . "</td>" .
              "<td>" . $materia->horario . "</td>" .
              "<td>" .
              "<form method='post'>" .
              "<button formaction='registroMateria.php' class='btn btn-primary' name='id' value='" . $materia->id . "'>Editar</button>" .
              "<button type='button' class='btn btn-danger' onclick='confirmar(this)' name='id' value='" . $materia->id . "'>Eliminar</button>" .
              "</form>" .
              "</td>" .
              "</tr>";
          }
